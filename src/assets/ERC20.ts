export const ERC20TokenABI = [
    {
      inputs: [
        ...
        { internalType: 'uint256[]', name: '_curve', type: 'uint256[]' },
      ],
    ...
    { inputs: [], name: 'CurveIncreaseError', type: 'error' },
    ...
    { inputs: [], name: 'MaxBonusError', type: 'error' },
    { inputs: [], name: 'NotGovError', type: 'error' },
    {
      inputs: [
    ...
    { inputs: [], name: 'ShortCurveError', type: 'error' },
    {
    ...
    {
      inputs: [{ internalType: 'uint256', name: '_maxBonus', type: 'uint256' }],
      name: 'adjustMaxBonus',
      outputs: [],
      stateMutability: 'nonpayable',
      type: 'function',
      ...
      outputs: [
        {
          ...
          internalType: 'struct TimeLockStaking.Deposit[]',
          name: '',
          type: 'tuple[]',
        },
      ],
    ...
    {
      inputs: [
        { internalType: 'uint256', name: '_newPoint', type: 'uint256' },
